...
- Updated Brazilian (pt\_BR) `cehone` formatter to make it more flexible [\#623](https://github.com/fzaninotto/Faker/pull/623) ([igorsantos07](https://github.com/igorsantos07))
...
* Added fuath parameter to Image provider (stefanosala)
