...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="<?= $this->include('assets/images/favicon.jpg.base64'); ?>">
    ...
    <body>
        ...
        <?php if (class_exists(\Symfony\Component\HttpKernel\Kernel::class)) { ?>
            <header>
                <div class="container">
                    <h1 class="logo"><?= $this->include('assets/images/symfony-logo dashboard.jpg'); ?> Symfony Exception</h1>
