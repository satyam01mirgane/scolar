...
unset($__errorArgs, $__bag); ?>" name="email" id="email" placeholder="Enter your email" required value="<?php echo e(old('email')); ?>">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="country" name="country" required>
                                        ...
                                        <option value="<?php echo e($v->id); ?>" <?php echo e(old('country') == $v->id ? 'selected' : ''); ?>><?php echo e($v->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4 text-center">
                            ...
                            <a href="<?php echo e(url('login')); ?>" class="small fw-bold">Sign in</a>
                        </div>
                    </div>
                </div>
            </div>
...
document.getElementById('email').addEventListener('blur', function () {
    ...
    fetch(`<?php echo e(url('check-email')); ?>?email=${email}`)
...
<?php /**PATH D:\New folder\htdocs\RUN\resources\views/auth/register.blade.php ENDPATH**/ ?>