    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 text-center image-column" data-aos="zoom-in" data-aos-delay="900">
                <img src="<?php echo e(asset('assets/images/ABOUTUS.jpeg')); ?>" alt="About Us" class="img-fluid animate-image" style="border-radius: 12px; box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.1);">
            </div>
        </div>
