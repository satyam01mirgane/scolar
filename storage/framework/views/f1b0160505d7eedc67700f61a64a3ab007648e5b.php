    ...
    <div class="container">
        ...
        <div class="row course-card mb-5 p-4 shadow-lg rounded-4" style="background-color: #ffffff; transition: all 0.3s ease; border-radius: 16px; opacity: 0; animation: fadeIn 0.6s ease-out forwards;">
            <div class="col-md-4 d-flex align-items-center justify-content-center">
                <img src="<?php echo e(asset($course_details->image)); ?>" alt="<?php echo e($course_details->name); ?>" class="img-fluid rounded-4 course-image" style="object-fit: cover; max-height: 0px; border-radius: 12px; transition: all 0.3s ease;">
            </div>
            <div class="col-md-8">
