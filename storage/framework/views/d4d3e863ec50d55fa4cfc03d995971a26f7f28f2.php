            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right" style="background: none; padding: 0;">
                        <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>" style="color: #007bff; text-decoration: none;">Home</a></li>
                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline" style="border-radius: 15px; box-shadow: 0 0 20px rgba(0,0,0,0.1); overflow: hidden; transition: all 0.3s ease;">
                        <div class="card-body box-profile" style="padding: 30px;">
                            ...
                            <h3 class="profile-username text-center" style="font-size: 1.5rem; color: #333; margin-bottom: 10px;"><?php echo e(Auth::user()->name); ?></h3>
                            <div class="text-center text-sm text-primary" style="font-size: 0.9rem;">Member Since <?php echo e(date('d M Y',strtotime(Auth::user()->created_at))); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary" style="border-radius: 15px; box-shadow: 0 0 20px rgba(0,0,0,0.1); overflow: hidden; margin-top: 20px; transition: all 0.3s ease;">
                        ...
                        <div class="card-body" style="padding: 20px;">
                            ...
                            <p class="text-muted" style="margin-top: 5px; font-size: 0.9rem;"><?php echo e(Auth::user()->address); ?></p>
                        </div>
                    </div>
                </div>
                <!-- /.col -->
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="2" style="border-top: none;">
                                            <a href="<?php echo e(url('profile-edit')); ?>" class="badge bg-danger" style="float: right; padding: 10px 15px; font-size: 0.9rem; text-decoration: none; background-color: #dc3545; color: #fff; border-radius: 5px; transition: all 0.3s ease;">Edit Profile</a>
                                        </td>
                                    </tr>
                                    <tr style="transition: all 0.3s ease;">
                                        <th style="width: 30%; padding: 20px; font-size: 1rem; color: #333;">Personal ID</th>
                                        <td style="padding: 20px; font-size: 1rem; color: #666;">User<?php echo e(Auth::user()->unique_id); ?></td>
                                    </tr>
                                    <tr style="transition: all 0.3s ease;">
                                        <th style="width: 30%; padding: 20px; font-size: 1rem; color: #333;">Name</th>
                                        <td style="padding: 20px; font-size: 1rem; color: #666;"><?php echo e(Auth::user()->name); ?></td>
                                    </tr>
                                    <tr style="transition: all 0.3s ease;">
                                        <th style="width: 30%; padding: 20px; font-size: 1rem; color: #333;">Email Address</th>
                                        <td style="padding: 20px; font-size: 1rem; color: #666;"><?php echo e(Auth::user()->email); ?></td>
                                    </tr>
                                    <tr style="transition: all 0.3s ease;">
                                        <th style="width: 30%; padding: 20px; font-size: 1rem; color: #333;">Contact Number</th>
                                        <td style="padding: 20px; font-size: 1rem; color: #666;"><?php echo e(Auth::user()->phone_number); ?></td>
                                    </tr>
                                    <tr style="transition: all 0.3s ease;">
                                    ...
                                    <tr style="transition: all 0.3s ease;">
                                        ...
                                        <td style="padding: 20px; font-size: 1rem; color: #666;"><?php echo e(Auth::user()->address); ?></td>
                                    </tr>
                                    <tr style="transition: all 0.3s ease;">
                                        <th style="width: 30%; padding: 20px; font-size: 1rem; color: #333;">Pincode</th>
                                        <td style="padding: 20px; font-size: 1rem; color: #666;"><?php echo e(Auth::user()->pincode); ?></td>
                                    </tr>
                                    <tr style="transition: all 0.3s ease;">
                                        <th style="width: 30%; padding: 20px; font-size: 1rem; color: #333;">Date of Birth</th>
                                        <td style="padding: 20px; font-size: 1rem; color: #666;"><?php echo e(date('d-M-Y',strtotime(Auth::user()->dob))); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
