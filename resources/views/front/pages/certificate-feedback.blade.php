                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($v->session_status != 'Open')
                                                        <a href="{{ url('certificates/'.$v->product_id.'.pdf') }}" target="_blank">Certificate</a>
                                                    @else
                                                ...
                                                <td>
                                                    @if($v->session_status != 'Open')
                                                        <div class="d-flex justify-content-start gap-3">
                                                            ...
                                                            <!-- Copy to Clipboard -->
                                                            <a href="#" onclick="copyToClipboard('🎉 I’m thrilled to announce that I’ve successfully completed the masterclass \'{{ $v->workshopname }}\' under the expert guidance of {{ $v->trainername }}. 🚀💡 This experience has been truly enriching! Check out my certificate here: {{ url('certificates/'.$v->product_id.'.pdf') }} #VIEF #Vscholar @vscholar #{{ str_replace(' ', '', $v->workshopname) }} #{{ str_replace(' ', '', $v->trainername) }}')" title="Copy Link">
